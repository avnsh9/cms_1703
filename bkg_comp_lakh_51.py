...
calculated_monoj1=np.genfromtxt('/home/avnsh9/workspace/checkmate2/results/lakh_pit_51/analysis/myprocess_cms1703_01651_signal.dat',usecols=4,skip_header=15,skip_footer=7)
calculated_monoj2=np.genfromtxt('/home/avnsh9/workspace/checkmate2/results/lakh_pit_51/analysis/myprocess_cms1703_01651_signal.dat',usecols=4,skip_header=12,skip_footer=25)
calculated_monov=np.genfromtxt('/home/avnsh9/workspace/checkmate2/results/lakh_pit_51/analysis/myprocess_cms1703_01651_signal.dat',usecols=4,skip_header=33)
...
print("monoj",a)
print("monov",b)
calculated_monoj1_err=np.genfromtxt("/home/avnsh9/workspace/checkmate2/results/lakh_pit_51/evaluation/myprocess_processResults.txt",usecols=3,skip_header=4,skip_footer=7)
calculated_monoj2_err=np.genfromtxt("/home/avnsh9/workspace/checkmate2/results/lakh_pit_51/evaluation/myprocess_processResults.txt",usecols=3,skip_header=1,skip_footer=25)
calculated_monov_err=np.genfromtxt("/home/avnsh9/workspace/checkmate2/results/lakh_pit_51/evaluation/myprocess_processResults.txt",usecols=3,skip_header=22)
...
given_monoj=np.genfromtxt('z_muon_given.dat',usecols=2,skip_header=2)
...
plt.errorbar(x,ratio_j,yerr=j_r_e,fmt='o',ecolor='r')
