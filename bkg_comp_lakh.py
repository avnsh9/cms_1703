...
calculated_monoj1=np.genfromtxt('/home/avnsh9/workspace/checkmate2/results/lakh_pit/analysis/myprocess_cms1703_test_signal.dat',usecols=4,skip_header=17,skip_footer=7)
calculated_monoj2=np.genfromtxt('/home/avnsh9/workspace/checkmate2/results/lakh_pit/analysis/myprocess_cms1703_test_signal.dat',usecols=4,skip_header=14,skip_footer=26)
...
print("monoj",a)
print("monov",b)
calculated_monoj1_err=np.genfromtxt("/home/avnsh9/workspace/checkmate2/results/lakh_pit/evaluation/myprocess_processResults.txt",usecols=3,skip_header=4,skip_footer=7)
calculated_monoj2_err=np.genfromtxt("/home/avnsh9/workspace/checkmate2/results/lakh_pit/evaluation/myprocess_processResults.txt",usecols=3,skip_header=1,skip_footer=26)
